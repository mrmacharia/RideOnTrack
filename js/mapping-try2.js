    ...
    //alert(originName); 
       ...
       // searchAddress();
        ...
        $('.dateBooking').on('click', function(){
            originInput="dateOrigin";
            destinationInput="dateDestination";
            theMapId="mapDateBooking";
            getOrigin();
            getDestination();
        });

        $('.scheduleCalender').on('click', function(){
            originInput="originCalendar";
            destinationInput="destinationCalendar";
            theMapId="mapCalendar";
            getOrigin();
            getDestination();
        });
        ...
        function getOrigin(){
            ...
            Autocomplete.addListener("place_changed",() => {
                var theMappingID='#'+theMapId;
                //alert(theMappingID);
                $(theMappingID).removeClass('d-none');
                ...
                //alert(originName);
                distanceMatrixRouting(latOrigin, longOrigin,latDestination,longDestination,originName);  
        ...
        function distanceMatrixRouting(latOrigin, longOrigin,latDestination,longDestination,originName){
            // alert(latOrigin);
            ...
            matrixService.getDistanceMatrix(
              ...
              function callback(response, status) {
                if (status !== "OK") {
                    ...
                    var distance_in_kilo = distance.value //in KM
                    var distance_in_mile = distance.value / 1609.34; // the mile
                    var duration_text = duration.text;
                    var duration_value = duration.value;
                    $('.journey-duration').text(duration_text);
                    $('.journey-distance').text(distance.text);  
                    
                    $('#originLat').text(latOrigin);
                    $('#originLng').text(longOrigin);
                    $('#destinationLat').text(latDestination);
                    $('#destinationLng').text(longDestination);
                  }
              }
